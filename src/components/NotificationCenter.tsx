    ...
    if (notifications.length === 0) {
        return (
            <div className="w-full py-6 flex flex-col items-center gap-3">
                ...
                <animate.p className="text-sm text-center text-muted-foreground" delay={0.15}>No notifications yet</animate.p>
            </div>
        );
    }
...
function NotificationItem({ notification }: { notification: Notification }) {
    ...
    return (
        <div className="px-2 pt-1.5 pb-2 flex flex-col gap-1 hover:bg-foreground/3 rounded-sm group transition-colors">
