...
export function Toolbar({ children, className, shade = "full" }: Props) {
    return (
        <div
            className={cn("p-2 flex justify-between items-center gap-2 sticky top-0 left-0 right-0 group/toolbar z-10 [&>div:first-of-type]:justify-start [&>div:last-of-type]:justify-end", className)}
            data-shade={shade}
        >
            {children}
